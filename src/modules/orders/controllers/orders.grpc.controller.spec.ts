...
describe("OrdersgRPCController", () => {
    ...
    describe("getOrders", () => {
        it("should return an array of all orders", (done) => {
            ...
            const dto: GetOrdersRequestDTO = {
                ids: undefined, // No specific IDs, fetch all orders
            };
    ...
    describe("updateOrder", () => {
        it("should update an existing order and return the updated order", (done) => {
            ...
            controller.updateOrder(dto, null, null).subscribe((response) => {
        ...
        it("should throw NotFoundException if order to update is not found", (done) => {
            ...
            controller.updateOrder(dto, null, null).subscribe({
                error: (err) => {
    ...
    describe("updateOrderStatus", () => {
        it("should update an order status", (done) => {
            ...
            controller
                .updateOrderStatus(dto, null, null)
                .subscribe((response) => {
                    expect(ordersService.updateOrder).toHaveBeenCalledWith(
                        id,
                        dto
    ...
    describe("deleteOrder", () => {
        it("should delete an order and return", (done) => {
            ...
            controller.deleteOrder(dto, null, null).subscribe((response) => {
        ...
        it("should throw NotFoundException if order to delete is not found", (done) => {
            ...
            controller.deleteOrder(dto, null, null).subscribe({
                error: (err) => {
                    expect(ordersService.deleteOrder).toHaveBeenCalledWith(id);
                    expect(err).toBeInstanceOf(NotFoundException);
                    expect(err.message).toBe(errorMessage);
    ...
    describe("confirmOrder", () => {
        it("should confirm an order and return", (done) => {
            ...
            controller.confirmOrder(dto, null, null).subscribe((response) => {
        ...
        it("should throw NotFoundException if order to confirm is not found", (done) => {
            ...
            controller.confirmOrder(dto, null, null).subscribe({
                error: (err) => {
                    expect(
